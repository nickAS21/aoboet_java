...
public class MediaSessionCompat {
    ...
    static PlaybackStateCompat getStateWithUpdatedPosition(PlaybackStateCompat playbackStateCompat, MediaMetadataCompat mediaMetadataCompat) {
        ...
        long updateTime = playbackStateCompat.getLastPositionUpdateTime();
        if (updateTime <= 0) {
            return playbackStateCompat;
        }

        long elapsedRealtime = SystemClock.elapsedRealtime();
        float speed = playbackStateCompat.getPlaybackSpeed();
        long currentPosition = (long) (speed * (elapsedRealtime - updateTime)) + position;
        ...
        return new PlaybackStateCompat.Builder(playbackStateCompat)
                .setState(state, currentPosition, speed, elapsedRealtime)
                .build();
    }
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    handleMediaPlayPauseKeySingleTapIfPending((MediaSessionManager.RemoteUserInfo) message.obj);
                }
            }
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public class MessageHandler extends Handler {
            ...
            @Override // android.os.Handler
            public void handleMessage(Message message) {
                Callback callback = (Callback) mCallback;
                if (callback == null) {
                    return;
                }
                ...
                try {
                    switch (message.what) {
                        case 1:
                            ...
                            ((MediaSessionCompat.Callback) callback).onCommand(command.command, command.extras, command.stub);
                            break;
                        case 2:
                            MediaSessionImplBase.this.adjustVolume(message.arg1, 0);
                            break;
                        case 3:
                            ((MediaSessionCompat.Callback) callback).onPrepare();
                            break;
                        case 4:
                            ((MediaSessionCompat.Callback) callback).onPrepareFromMediaId((String) message.obj, bundle);
                            break;
                        case 5:
                            ((MediaSessionCompat.Callback) callback).onPrepareFromSearch((String) message.obj, bundle);
                            break;
                        case 6:
                            ((MediaSessionCompat.Callback) callback).onPrepareFromUri((Uri) message.obj, bundle);
                            break;
                        case 7:
                            ((MediaSessionCompat.Callback) callback).onPlay();
                            break;
                        case 8:
                            ((MediaSessionCompat.Callback) callback).onPlayFromMediaId((String) message.obj, bundle);
                            break;
                        case 9:
                            ((MediaSessionCompat.Callback) callback).onPlayFromSearch((String) message.obj, bundle);
                            break;
                        case 10:
                            ((MediaSessionCompat.Callback) callback).onPlayFromUri((Uri) message.obj, bundle);
                            break;
                        case 11:
                            ((MediaSessionCompat.Callback) callback).onSkipToQueueItem(((Long) message.obj).longValue());
                            break;
                        case 12:
                            ((MediaSessionCompat.Callback) callback).onPause();
                            break;
                        case 13:
                            ((MediaSessionCompat.Callback) callback).onStop();
                            break;
                        case 14:
                            ((MediaSessionCompat.Callback) callback).onSkipToNext();
                            break;
                        case 15:
                            ((MediaSessionCompat.Callback) callback).onSkipToPrevious();
                            break;
                        case 16:
                            ((MediaSessionCompat.Callback) callback).onFastForward();
                            break;
                        case 17:
                            ((MediaSessionCompat.Callback) callback).onRewind();
                            break;
                        case 18:
                            ((MediaSessionCompat.Callback) callback).onSeekTo(((Long) message.obj).longValue());
                            break;
                        case 19:
                            ((MediaSessionCompat.Callback) callback).onSetRating((RatingCompat) message.obj);
                            break;
                        case 20:
                            ((MediaSessionCompat.Callback) callback).onCustomAction((String) message.obj, bundle);
                            break;
                        case 21:
                            KeyEvent keyEvent = (KeyEvent) message.obj;
                            Intent intent = new Intent("android.intent.action.MEDIA_BUTTON");
                            intent.putExtra("android.intent.extra.KEY_EVENT", keyEvent);
                            if (!((MediaSessionCompat.Callback) callback).onMediaButtonEvent(intent)) {
                        ...
                        case 22:
                            ...
                            break;
                        case 23:
                            ((MediaSessionCompat.Callback) callback).onSetRepeatMode(message.arg1);
                            break;
                        case 25:
                            ((MediaSessionCompat.Callback) callback).onAddQueueItem((MediaDescriptionCompat) message.obj);
                            break;
                        case 26:
                            ((MediaSessionCompat.Callback) callback).onAddQueueItem((MediaDescriptionCompat) message.obj, message.arg1);
                            break;
                        case 27:
                            ((MediaSessionCompat.Callback) callback).onRemoveQueueItem((MediaDescriptionCompat) message.obj);
                            break;
                        case 28:
                            if (MediaSessionImplBase.this.mQueue != null) {
                                ...
                                if (queueItem != null) {
                                    ((MediaSessionCompat.Callback) callback).onRemoveQueueItem(queueItem.getDescription());
                                    break;
                                }
                            }
                            break;
                        case 29:
                            ((MediaSessionCompat.Callback) callback).onSetCaptioningEnabled(((Boolean) message.obj).booleanValue());
                            break;
                        case 30:
                            ((MediaSessionCompat.Callback) callback).onSetShuffleMode(message.arg1);
                            break;
                        case 31:
                            ((MediaSessionCompat.Callback) callback).onSetRating((RatingCompat) message.obj, bundle);
                            break;
                    }
                } finally {
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public final MediaSessionManager.RemoteUserInfo getCurrentControllerInfo() {
            return new MediaSessionManager.RemoteUserInfo(((android.support.v4.media.session.MediaSessionCompat) this.mSessionObj).getCurrentControllerInfo());
        }
    }
}
