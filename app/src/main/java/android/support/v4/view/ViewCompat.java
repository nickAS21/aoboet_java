...
public class ViewCompat {
    ...
    public static int getMinimumWidth(View view) {
        if (Build.VERSION.SDK_INT >= 16) {
            ...
            return 0; // або встановити мінімальну ширину за замовчуванням
        }


//        // Reflection fallback для дуже старих Android
//        try {
//            Field minWidthField = View.class.getDeclaredField("mMinWidth");
//            minWidthField.setAccessible(true);
//            return (Integer) minWidthField.get(view);
//        } catch (NoSuchFieldException | IllegalAccessException | ClassCastException e) {
//            // Поля немає або не вдалося дістати — повертаємо 0
//            return 0;
//        }
    }
    ...
    public static int getMinimumHeight(View view) {
        ...
        if (!sMinHeightFieldFetched) {
            try {
                @SuppressLint("SoonBlockedPrivateApi") Field declaredField = View.class.getDeclaredField("mMinHeight");
