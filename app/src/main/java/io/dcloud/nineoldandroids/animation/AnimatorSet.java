...
public final class AnimatorSet extends Animator {
    ...
    @Override // io.dcloud.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public AnimatorSet m4clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.m4clone();
        ...
        while (it.hasNext()) {
            ...
            animatorSet.mNodes.add(m5clone);
            animatorSet.mNodeMap.put(m5clone.animation, m5clone);
            ArrayList arrayList = null;
            m5clone.dependencies = null;
            m5clone.tmpDependencies = null;
            m5clone.nodeDependents = null;
            m5clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = m5clone.animation.getListeners();
            if (listeners != null) {
    ...
    public static class Node implements Cloneable {
        ...
        public Node m5clone() {
            try {
                ...
                node.animation = this.animation.m4clone();
                return node;
