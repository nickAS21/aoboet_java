...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public long getCurrentPosition(Long l) {
        return (long) Math.max(0L, this.mPosition + (this.mSpeed * ((float) (l != null ? l.longValue() : SystemClock.elapsedRealtime() - this.mUpdateTime))));
    }
    ...
    public static PlaybackStateCompat fromPlaybackState(Object obj) {
        ...
        List<PlaybackState.CustomAction> customActions = PlaybackStateCompatApi21.getCustomActions(obj);
