...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public void onMeasure(int i, int i2) {
        ...
        view.measure(View.MeasureSpec.makeMeasureSpec((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight(), MeasureSpec.EXACTLY), View.MeasureSpec.makeMeasureSpec((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), MeasureSpec.EXACTLY));
        this.mCircleView.measure(View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, MeasureSpec.EXACTLY), View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, MeasureSpec.EXACTLY));
        this.mCircleViewIndex = -1;
    ...
    void moveToStart(float f) {
        setTargetOffsetTopAndBottom((this.mFrom + (int) ((this.mOriginalOffsetTop - this.mCurrentTargetOffsetTop) * f)) - this.mCircleView.getTop());
