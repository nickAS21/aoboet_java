...
public class SlidingPaneLayout extends ViewGroup {
    ...
    void updateObscuredViewsVisibility(View view) {
        ...
        while (i5 < childCount && (childAt = getChildAt(i5)) != view2) {
            if (childAt.getVisibility() == View.GONE) {
                ...
                z = isLayoutRtlSupport;
                childAt.setVisibility((Math.max(isLayoutRtlSupport ? paddingLeft : width, childAt.getLeft()) < i || Math.max(paddingTop, childAt.getTop()) < i3 || Math.min(isLayoutRtlSupport ? width : paddingLeft, childAt.getRight()) > i2 || Math.min(height, childAt.getBottom()) > i4) ? View.VISIBLE : View.INVISIBLE);
            }
            i5++;
            view2 = view;
    ...
    private static boolean viewIsOpaque(View view) {
        ...
        return Build.VERSION.SDK_INT < 18 && (background = view.getBackground()) != null && background.getOpacity() == PixelFormat.OPAQUE;
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (mode != MeasureSpec.EXACTLY) {
            ...
            if (mode != MeasureSpec.AT_MOST && mode == 0) {
                size = 300;
            }
        } else if (mode2 == 0) {
            if (!isInEditMode()) {
            ...
            if (mode2 == 0) {
                size2 = 300;
                mode2 = MeasureSpec.AT_MOST;
            }
        }
        boolean z = false;
        if (mode2 != MeasureSpec.AT_MOST) {
            i3 = mode2 != MeasureSpec.EXACTLY ? 0 : (size2 - getPaddingTop()) - getPaddingBottom();
            paddingTop = i3;
        } else {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == View.GONE) {
                ...
                if (layoutParams.width == -2) {
                    makeMeasureSpec3 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i9, MeasureSpec.AT_MOST);
                } else if (layoutParams.width == -1) {
                    makeMeasureSpec3 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i9, MeasureSpec.EXACTLY);
                } else {
                    makeMeasureSpec3 = View.MeasureSpec.makeMeasureSpec(layoutParams.width, MeasureSpec.EXACTLY);
                }
                if (layoutParams.height == -2) {
                    makeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(paddingTop, MeasureSpec.AT_MOST);
                } else if (layoutParams.height == -1) {
                    makeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(paddingTop, MeasureSpec.EXACTLY);
                } else {
                    makeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, MeasureSpec.EXACTLY);
                }
                childAt.measure(makeMeasureSpec3, makeMeasureSpec4);
                int measuredWidth = childAt.getMeasuredWidth();
                int measuredHeight = childAt.getMeasuredHeight();
                if (mode2 == MeasureSpec.AT_MOST && measuredHeight > i3) {
                ...
                if (childAt2.getVisibility() != i4) {
                    ...
                    if (childAt2.getVisibility() != i4) {
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width == 0) {
                                    if (layoutParams2.height == -2) {
                                        makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(paddingTop, MeasureSpec.AT_MOST);
                                    } else if (layoutParams2.height == -1) {
                                        makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(paddingTop, MeasureSpec.EXACTLY);
                                    } else {
                                        makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, MeasureSpec.EXACTLY);
                                    }
                                } else {
                                    makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), MeasureSpec.EXACTLY);
                                }
                                if (z2) {
                                    int i12 = paddingLeft - (layoutParams2.leftMargin + layoutParams2.rightMargin);
                                    i5 = i10;
                                    int makeMeasureSpec5 = View.MeasureSpec.makeMeasureSpec(i12, MeasureSpec.EXACTLY);
                                    ...
                                    i5 = i10;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.weight * Math.max(0, i8)) / f)), MeasureSpec.EXACTLY), makeMeasureSpec);
                                    i11++;
                                    i10 = i5;
                                    i4 = 8;
                                }
                            ...
                            if (z4) {
                                if (layoutParams2.height == -2) {
                                    makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(paddingTop, MeasureSpec.AT_MOST);
                                    i6 = MeasureSpec.EXACTLY;
                                } else if (layoutParams2.height == -1) {
                                    i6 = MeasureSpec.EXACTLY;
                                    makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(paddingTop, MeasureSpec.EXACTLY);
                                } else {
                                    i6 = MeasureSpec.EXACTLY;
                                    makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, MeasureSpec.EXACTLY);
                                }
                            } else {
                                i6 = MeasureSpec.EXACTLY;
                                makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), MeasureSpec.EXACTLY);
                            }
    ...
    private void dimChildView(View view, float f, int i) {
        ...
        if (f > 0.0f && i != 0) {
            ...
            if (view.getLayerType() != View.LAYER_TYPE_HARDWARE) {
                view.setLayerType(View.LAYER_TYPE_HARDWARE, layoutParams.dimPaint);
            }
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (!filter(childAt) && childAt.getVisibility() == View.VISIBLE) {
    ...
    public class DisableLayerRunnable implements Runnable {
        ...
        public void run() {
            if (this.mChildView.getParent() == SlidingPaneLayout.this) {
                this.mChildView.setLayerType(View.LAYER_TYPE_NONE, null);
