...
public class GlobalHistogramBinarizer extends Binarizer {
    ...
    @Override // com.dcloud.zxing.Binarizer
    public BitArray getBlackRow(int i, BitArray bitArray) throws NotFoundException {
        ...
        int i4 = 1;
        int i5 = row[0] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE;
        int i6 = row[1] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE;
        while (i4 < width - 1) {
            int i7 = i4 + 1;
            int i8 = row[i7] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE;
