...
public class ShortcutCreateUtil {
    ...
    static {
        ...
        selfDisablePackages.add("com.gionee.amisystem");
    ...
    public static boolean isDisableShort(Context context) {
        ...
        if ((launcherPackageName.equals("com.android.launcher3") && Build.BRAND.equalsIgnoreCase(MobilePhoneModel.SMARTISAN)) || Build.BRAND.equalsIgnoreCase(MobilePhoneModel.MEIZU)) {
            return false;
        }
        if (Build.BRAND.equalsIgnoreCase(MobilePhoneModel.COOLPAD) && launcherPackageName.equals("com.yulong.android.launcher3") && Build.VERSION.SDK_INT >= 19) {
            return true;
