...
final class AlignmentPatternFinder {
    ...
    */
    private float crossCheckVertical(int r10, int r11, int r12, int r13) {
        /*
            r9 = this;
            com.dcloud.zxing.common.BitMatrix r0 = r9.image
            int r1 = r0.getHeight()
        ...
        L9b:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dcloud.zxing.qrcode.detector.AlignmentPatternFinder.crossCheckVertical(int, int, int, int):float");
    }
