...
public final class ArraySet_Old<E>  {
//public final class ArraySet_Old<E> implements Collection<E>, Set<E> {
//    private static final int BASE_SIZE = 4;
//    private static final int CACHE_SIZE = 10;
//    private static final boolean DEBUG = false;
//    private static final int[] INT = new int[0];
//    private static final Object[] OBJECT = new Object[0];
//    private static final String TAG = "ArraySet_Old";
...
//        if (i == 8) {
//            synchronized (ArraySet_Old.class) {
...
////    public ArraySet_Old(ArraySet_Old<E> ArraySet_Old) {
////        this();
////        if (ArraySet_Old != 0) {
////            addAll((ArraySet_Old) ArraySet_Old);
////        }
////    }
////
////    /* JADX WARN: Multi-variable type inference failed */
////    public ArraySet_Old(Collection<E> collection) {
////        this();
////        if (collection != 0) {
////            addAll(collection);
////        }
...
//    }
//
//    public void addAll(ArraySet_Old<? extends E> ArraySet_Old) {
//        int i = ArraySet_Old.mSize;
//        ensureCapacity(this.mSize + i);
//        if (this.mSize != 0) {
//            for (int i2 = 0; i2 < i; i2++) {
//                add(ArraySet_Old.valueAt(i2));
//            }
//        } else if (i > 0) {
//            System.arraycopy(ArraySet_Old.mHashes, 0, this.mHashes, 0, i);
//            System.arraycopy(ArraySet_Old.mArray, 0, this.mArray, 0, i);
//            this.mSize = i;
//        }
//    }
//
...
//    }
//
//    public boolean removeAll(ArraySet_Old<? extends E> ArraySet_Old) {
//        int i = ArraySet_Old.mSize;
//        int i2 = this.mSize;
//        for (int i3 = 0; i3 < i; i3++) {
//            remove(ArraySet_Old.valueAt(i3));
//        }
...
//            this.mCollections = new MapCollections<E, E>() { // from class: android.support.v4.util.ArraySet_Old.1
//                @Override // android.support.v4.util.MapCollections
//                protected int colGetSize() {
//                    return ArraySet_Old.this.mSize;
//                }
//
//                @Override // android.support.v4.util.MapCollections
//                protected Object colGetEntry(int i, int i2) {
//                    return ArraySet_Old.this.mArray[i];
//                }
//
//                @Override // android.support.v4.util.MapCollections
//                protected int colIndexOfKey(Object obj) {
//                    return ArraySet_Old.this.indexOf(obj);
//                }
//
//                @Override // android.support.v4.util.MapCollections
...
//                    ArraySet_Old.this.removeAt(i);
//                }
//
//                @Override // android.support.v4.util.MapCollections
//                protected void colClear() {
//                    ArraySet_Old.this.clear();
//                }
//            };
//        }
