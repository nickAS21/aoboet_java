...
public final class NotificationManagerCompat {
    ...
    public static class SideChannelManager implements Handler.Callback, ServiceConnection {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            if (Log.isLoggable(NotificationManagerCompat.TAG, Log.DEBUG)) {
        ...
        private boolean ensureServiceBound(ListenerRecord listenerRecord) {
            ...
            listenerRecord.bound = this.mContext.bindService(new Intent(NotificationManagerCompat.ACTION_BIND_SIDE_CHANNEL).setComponent(listenerRecord.componentName), this, Context.BIND_AUTO_CREATE | Context.BIND_WAIVE_PRIORITY);
            if (listenerRecord.bound) {
                listenerRecord.retryCount = 0;
            } else {
