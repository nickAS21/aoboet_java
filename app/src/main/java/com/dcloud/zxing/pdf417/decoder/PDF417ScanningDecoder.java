...
public final class PDF417ScanningDecoder {
    ...
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i, int i2) throws NotFoundException, FormatException, ChecksumException {
        ...
        for (int i7 = 0; i7 < 2; i7++) {
            ...
            if (i7 == 0 && (detectionResult.getBoundingBox().getMinY() < boundingBox.getMinY() || detectionResult.getBoundingBox().getMaxY() > boundingBox.getMaxY())) {
    ...
    */
    private static int[] getModuleBitCount(com.dcloud.zxing.common.BitMatrix r7, int r8, int r9, boolean r10, int r11, int r12) {
        /*
            r0 = 8
            int[] r1 = new int[r0]
            r2 = 1
        ...
        L38:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dcloud.zxing.pdf417.decoder.PDF417ScanningDecoder.getModuleBitCount(com.dcloud.zxing.common.BitMatrix, int, int, boolean, int, int):int[]");
    }
