...
public final class Code128Reader extends OneDReader {
        ...
        while (nextSet < size) {
            if (bitArray.get(nextSet) ^ z) {
                ...
                if (i == 5) {
                    int i3 = 64;
                    int i4 = -1;
                    for (int i5 = CODE_START_A; i5 <= CODE_START_C; i5++) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:70:0x00de, code lost:
        ...
        if (r14 != com.dcloud.zxing.oned.Code128Reader.CODE_STOP) goto L69;
     */
    ...
    */
    public com.dcloud.zxing.Result decodeRow(int r25, com.dcloud.zxing.common.BitArray r26, java.util.Map<com.dcloud.zxing.DecodeHintType, ?> r27) throws com.dcloud.zxing.NotFoundException, com.dcloud.zxing.FormatException, com.dcloud.zxing.ChecksumException {
        /*
            Method dump skipped, instructions count: 534
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dcloud.zxing.oned.Code128Reader.decodeRow(int, com.dcloud.zxing.common.BitArray, java.util.Map):com.dcloud.zxing.Result");
    }
}
