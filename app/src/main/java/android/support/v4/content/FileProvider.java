...
public class FileProvider extends ContentProvider {
    ...
    private static PathStrategy parsePathStrategy(Context context, String str) throws IOException, XmlPullParserException {
        ...
        XmlResourceParser loadXmlMetaData = context.getPackageManager().resolveContentProvider(str, PackageManager.GET_META_DATA).loadXmlMetaData(context.getPackageManager(), META_DATA_FILE_PROVIDER_PATHS);
