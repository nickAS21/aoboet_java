...
public class ViewPager extends ViewGroup {
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new android.support.v4.view.OnApplyWindowInsetsListener() { // from class: android.support.v4.view.ViewPager.4
            private final Rect mTempRect = new Rect();

            @Override // android.support.v4.view.OnApplyWindowInsetsListener
            public android.support.v4.view.WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (true) {
            boolean z2 = true;
            int heightSpecMode = MeasureSpec.EXACTLY;
            if (i7 >= childCount) {
                break;
            }
            ...
            if (childAt.getVisibility() != View.GONE && (layoutParams2 = (LayoutParams) childAt.getLayoutParams()) != null && layoutParams2.isDecor) {
                ...
                if (z3) {
                    i3 = MeasureSpec.AT_MOST;
                    i11 = MeasureSpec.EXACTLY;
                } else {
                    i3 = z2 ? MeasureSpec.EXACTLY : MeasureSpec.AT_MOST;
                }
                if (layoutParams2.width != -2) {
                    i5 = layoutParams2.width != -1 ? layoutParams2.width : paddingLeft;
                    i4 = MeasureSpec.EXACTLY;
                } else {
                    i4 = i11;
                    i5 = paddingLeft;
                }
                ...
                childAt.measure(View.MeasureSpec.makeMeasureSpec(i5, i4), View.MeasureSpec.makeMeasureSpec(i6, heightSpecMode));
                if (z3) {
        ...
        this.mChildWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(paddingLeft, MeasureSpec.EXACTLY);
        ...
        for (int i12 = 0; i12 < childCount2; i12++) {
            ...
            if (childAt2.getVisibility() != View.GONE && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.isDecor)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (paddingLeft * layoutParams.widthFactor), MeasureSpec.EXACTLY), this.mChildHeightMeasureSpec);
            }
        }
    }
    ...
    */
    ...
    private void enableLayers(boolean z) {
        int childCount = getChildCount();
        for (int i = 0; i < childCount; i++) {
            getChildAt(i).setLayerType(z ? this.mPageTransformerLayerType : View.LAYER_TYPE_NONE, null);
        }
    }
    ...
    */
    ...
    public void addFocusables(ArrayList<View> arrayList, int i, int i2) {
        ...
        if ((descendantFocusability != FOCUS_AFTER_DESCENDANTS || size == arrayList.size()) && isFocusable()) {
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        for (int i = 0; i < childCount; i++) {
            View childAt = getChildAt(i);
            if (childAt.getVisibility() == View.VISIBLE && (infoForChild = infoForChild(childAt)) != null && infoForChild.position == this.mCurItem && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                return true;
            }
        }
        return false;
    ...
    public class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            ...
            if (accessibilityEvent.getEventType() != AccessibilityEvent.TYPE_VIEW_SCROLLED || ViewPager.this.mAdapter == null) {
                return;
            }
