...
public final class Encoder {
    ...
    private static boolean isOnlyDoubleByteKanji(String str) {
        try {
            ...
            for (int i = 0; i < length; i += 2) {
                int i2 = bytes[i] & IApp.ABS_PRIVATE_WWW_DIR_APP_MODE;
    ...
    /* renamed from: com.dcloud.zxing.qrcode.encoder.Encoder$1, reason: invalid class name */
    /* loaded from: classes.dex */
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$dcloud$zxing$qrcode$decoder$Mode;

        static {
            int[] iArr = new int[Mode.values().length];
            $SwitchMap$com$dcloud$zxing$qrcode$decoder$Mode = iArr;
            try {
                iArr[Mode.NUMERIC.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$dcloud$zxing$qrcode$decoder$Mode[Mode.ALPHANUMERIC.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$dcloud$zxing$qrcode$decoder$Mode[Mode.BYTE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$dcloud$zxing$qrcode$decoder$Mode[Mode.KANJI.ordinal()] = 4;
    ...
    static void appendBytes(String str, Mode mode, BitArray bitArray, String str2) throws WriterException {
        int i = AnonymousClass1.$SwitchMap$com$dcloud$zxing$qrcode$decoder$Mode[mode.ordinal()];
        if (i == 1) {
    ...
    */
    static void appendKanjiBytes(java.lang.String r6, com.dcloud.zxing.common.BitArray r7) throws com.dcloud.zxing.WriterException {
        /*
        ...
        L33:
            ...
            goto L8
        L44:
            com.dcloud.zxing.WriterException r6 = new com.dcloud.zxing.WriterException
        ...
        L4d:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dcloud.zxing.qrcode.encoder.Encoder.appendKanjiBytes(java.lang.String, com.dcloud.zxing.common.BitArray):void");
    }
