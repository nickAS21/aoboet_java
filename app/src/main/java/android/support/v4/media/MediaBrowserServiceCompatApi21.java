...
class MediaBrowserServiceCompatApi21 {
    ...
    public static void onCreate(Object obj) {
        ((MediaBrowserServiceCompat) obj).onCreate();
    }

    public static IBinder onBind(Object obj, Intent intent) {
        return ((MediaBrowserServiceCompat) obj).onBind(intent);
    }

    public static void setSessionToken(Object obj, Object obj2) {
        ((MediaBrowserServiceCompat) obj).setSessionToken((MediaSessionCompat.Token) obj2);
    }

    public static void notifyChildrenChanged(Object obj, String str) {
        ((MediaBrowserServiceCompat) obj).notifyChildrenChanged(str);
    }

    /* loaded from: classes.dex */
    static class ResultWrapper<T> {
        MediaBrowserServiceCompat.Result mResultObj;

        /* JADX INFO: Access modifiers changed from: package-private */
        public ResultWrapper(MediaBrowserServiceCompat.Result result) {
    ...
    /* loaded from: classes.dex */
    static class MediaBrowserServiceAdaptor extends MediaBrowserServiceCompat {
        ...
        public MediaBrowserServiceCompat.BrowserRoot onGetRoot(String str, int i, Bundle bundle) {
            ...
            return new MediaBrowserServiceCompat.BrowserRoot(onGetRoot.mRootId, onGetRoot.mExtras);
        }

        @Override
        public void onLoadChildren(String str, Result<List<MediaBrowserCompat.MediaItem>> result) {
