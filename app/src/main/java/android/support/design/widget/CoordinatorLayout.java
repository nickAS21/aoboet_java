    ...
    public void setStatusBarBackground(Drawable drawable) {
        ...
        if (drawable2 != drawable) {
            ...
            if (mutate != null) {
                ...
                this.mStatusBarBackground.setVisible(getVisibility() == View.VISIBLE, false);
    ...
    */
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            ...
            if (view.getVisibility() != View.GONE && ((behavior = ((LayoutParams) view.getLayoutParams()).getBehavior()) == null || !behavior.onLayoutChild(this, view, layoutDirection))) {
    ...
    void getChildRect(View view, boolean z, Rect rect) {
        if (view.isLayoutRequested() || view.getVisibility() == View.GONE) {
            rect.setEmpty();
        } else if (z) {
    ...
    final void onChildViewsChanged(int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            if (i != 0 || view.getVisibility() != View.GONE) {
                ...
                if (layoutParams.dodgeInsetEdges != 0 && view.getVisibility() == View.VISIBLE) {
    ...
    public boolean doViewsOverlap(View view, View view2) {
        boolean z = false;
        if (view.getVisibility() != View.VISIBLE || view2.getVisibility() != View.VISIBLE) {
            return false;
        }
        Rect acquireTempRect = acquireTempRect();
    ...
    private void setupForInsets() {
        if (Build.VERSION.SDK_INT < 21) {
            // На старих Android API < 21 — інсетів немає, виходимо
            return;
        }

        if (ViewCompat.getFitsSystemWindows(this)) {
            if (this.mApplyWindowInsetsListener == null) {
                this.mApplyWindowInsetsListener = new android.support.v4.view.OnApplyWindowInsetsListener() {
                    @Override
            ...
            setSystemUiVisibility(1280); // SYSTEM_UI_FLAG_LAYOUT_STABLE | SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
        } else {
