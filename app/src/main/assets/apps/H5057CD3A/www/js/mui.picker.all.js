...
(function($, document) {
	...
	var panelBuffer = '<div class="mui-poppicker">\
		<div class="mui-poppicker-header" style="overflow:hidden;">\
			<button class="mui-btn mui-poppicker-btn-cancel" style="width:20%; border:1px solid #cbcbcb; color:#666666;margin-left:5%;float:left;">cancel</button>\
			<button class="mui-btn mui-btn-blue mui-poppicker-btn-ok" style="width:20%;margin-right:5%;">sure</button>\
...
(function($, document) {
	...
	var domBuffer = '<div class="mui-dtpicker" data-type="datetime">\
		<div class="mui-dtpicker-header" style="overflow:hidden;">\
			<button data-id="btn-cancel" class="mui-btn" style="width:20%; border:1px solid #cbcbcb; color:#666666;margin-left:5%;float:left;">cancel</button>\
			<button data-id="btn-ok" class="mui-btn mui-btn-blue" style="width:20%;margin-right:5%;">sure</button>\
		</div>\
		<div class="mui-dtpicker-title"><h5 data-id="title-y">year</h5><h5 data-id="title-m">month</h5><h5 data-id="title-d">day</h5><h5 data-id="title-h">hour</h5><h5 data-id="title-i">min</h5></div>\
	...
	var DtPicker = $.DtPicker = $.Class.extend({
		...
		_create: function(options) {
			var self = this;
			options = options || {};
			options.labels = options.labels || ['year', 'month', 'day', 'hour', 'min'];
			options.buttons = options.buttons || ['cancel', 'sure'];
