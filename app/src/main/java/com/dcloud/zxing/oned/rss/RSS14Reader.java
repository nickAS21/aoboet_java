...
public final class RSS14Reader extends AbstractRSSReader {
    ...
    private Pair decodePair(BitArray bitArray, boolean z, int i, Map<DecodeHintType, ?> map) {
        try {
            ...
            if (resultPointCallback != null) {
                ...
                float f = (startEnd[0] + startEnd[1]) / 2.0f;
                if (z) {
    ...
    */
    private void adjustOddEvenCounts(boolean r10, int r11) throws com.dcloud.zxing.NotFoundException {
        /*
            Method dump skipped, instructions count: 230
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dcloud.zxing.oned.rss.RSS14Reader.adjustOddEvenCounts(boolean, int):void");
    }
}
