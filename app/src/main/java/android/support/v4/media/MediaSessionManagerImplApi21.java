...
class MediaSessionManagerImplApi21 extends MediaSessionManagerImplBase {
    ...
    private boolean hasMediaControlPermission(RemoteUserInfoImpl remoteUserInfoImpl) {
        return getContext().checkPermission("android.permission.MEDIA_CONTENT_CONTROL", remoteUserInfoImpl.getPid(), remoteUserInfoImpl.getUid()) == PackageManager.PERMISSION_GRANTED;
    }
}
