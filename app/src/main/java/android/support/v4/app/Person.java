...
public class Person {
    ...
    public android.app.Person toAndroidPerson() {
        return new Builder().setName(getName()).setIcon(getIcon() != null ? IconCompat.createFromIcon(getIcon().toIcon()) : null).setUri(getUri()).setKey(getKey()).setBot(isBot()).setImportant(isImportant()).build().toAndroidPerson();
    }
