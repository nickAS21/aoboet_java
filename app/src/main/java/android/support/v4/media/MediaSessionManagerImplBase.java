...
public class MediaSessionManagerImplBase implements MediaSessionManagerImpl {
    ...
    private boolean isPermissionGranted(RemoteUserInfoImpl remoteUserInfoImpl, String str) {
        return remoteUserInfoImpl.getPid() < 0 ?
                this.mContext.getPackageManager().checkPermission(str, remoteUserInfoImpl.getPackageName()) == PackageManager.PERMISSION_GRANTED :
                this.mContext.checkPermission(str, remoteUserInfoImpl.getPid(), remoteUserInfoImpl.getUid()) == PackageManager.PERMISSION_GRANTED;
    }
